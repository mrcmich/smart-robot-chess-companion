...
def get_position_world_xy(cell):
    ...
    cell_size = config.CHESS_BOARD_SIZE[0] / 10
    cell_row = int(cell[1])
    ...
    cell_position_x = config.EXTENDED_CHESS_BOARD_CELL_WA_POSITION_WORLD_XY[0] + cell_size * cell_row_index
    cell_position_y = config.EXTENDED_CHESS_BOARD_CELL_WA_POSITION_WORLD_XY[1] + cell_size * cell_column_index
